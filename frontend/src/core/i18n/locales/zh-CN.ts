...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，新工坊调度系统 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 新工坊调度系统 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 新工坊调度系统 的界面和行为。",
    sections: {
      appearance: "外观",
      memory: "记忆",
      tools: "工具",
    ...
    memory: {
      title: "记忆",
      description:
        "新工坊调度系统 会在后台不断从你的对话中自动学习。这些记忆能帮助 新工坊调度系统 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
